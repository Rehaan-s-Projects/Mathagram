#!/usr/bin/env python3
"""Generate Vectors course lesson HTML files.

Each per-unit Python file (scripts/vectors_units/unit_NN.py) imports
...
COURSE_DIR = os.path.join(REPO_ROOT, "course", "vectors")
...
SCRIPT_TMPL = """
  <script type="module">
    ...
    await showLessonComplete(container, completionDiv, score, {{ xp,
      courseId: 'vectors', lessonId: 'lesson-{lesson_num}', nextHref: '{next_href}', backHref: 'index.html'
    }});
