#!/usr/bin/env python3
"""Generate Meditation & Mindfulness course lesson HTML files.

Each per-unit Python file (scripts/meditation_units/unit_NN.py) imports
...
COURSE_DIR = os.path.join(REPO_ROOT, "courses", "meditation")
...
<body>
  ...
  <nav class="nav">
    <div class="container">
      ...
      <div class="nav-links">
        <a href="index.html">Meditation</a>
...
SCRIPT_TMPL = """
  <script type="module">
    ...
    await showLessonComplete(container, completionDiv, score, {{ xp,
      courseId: 'meditation', lessonId: 'lesson-{lesson_num}', nextHref: '{next_href}', backHref: 'index.html'
    }});
